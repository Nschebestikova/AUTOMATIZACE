#
# Ukázka práce s lokátory na webu Rohlik.cz
#
*** Settings ***
Library  Browser
...
# POZOR!!!  na rohlíku již byla většina ID odstraněna a třídy se stále mění
   #Co JEDE
#   ${text} =     Get Text    css=.sc-18g3ccf-3.iIgRWM               #výběr pomocí 2 class, nesmí mezi něma být mezera
#   ${text} =     Get Text    css=\#headerLogin
#   ${text} =     Get Text    id=header-user-icon
...
#   ${text} =     Get Text    css=[aria-label="sekce"]    #výběr pomocí Aria - informace pro zrakově postižené
