...
Check the table contains registered user with correct data
    ...
    FOR    ${counter}    IN RANGE    20  ${count_logs}
        Log    ${counter}
        ...
        IF    "${table_course}" == "${course}" and "${table_name}" == "${name} and "${table_surname}" == "${surname}" and "${table_email}" == "${email}" and "${table_phone}" == "${phone}" and "${table_typ_os}" == "${typ_os}" and "${table_address}" == "${address}" and "${table_ico}" == "${ico}" and "${table_count}" == "${count}" and "${table_comment}" == "${comment}" and "${table_souhlas}" == "${souhlas}"     BREAK

        #Exit For Loop If    "${table_course}" == "${course}" and "${table_name}" == "${name} and "${table_surname}" == "${surname}" and "${table_email}" == "${email}" and "${table_phone}" == "${phone}" and "${table_typ_os}" == "${typ_os}" and "${table_address}" == "${address}" and "${table_ico}" == "${ico}" and "${table_count}" == "${count}" and "${table_comment}" == "${comment}" and "${table_souhlas}" == "${souhlas}"
