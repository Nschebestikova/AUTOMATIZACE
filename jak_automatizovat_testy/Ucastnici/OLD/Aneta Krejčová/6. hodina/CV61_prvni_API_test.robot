...
Quick Get Reaquest With Parameters Test
       ${response}=      GET  https://www.google.com/search  params=query=ciao  expected_status=403
#       Status Should Be  200           //kontrola až pak místo expected status 403 není vhodná protože když hodí ze začátku chybu nahoře nedojde k dalšímu příkazu
