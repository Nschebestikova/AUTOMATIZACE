...
#POZTIVNI TESTY
Registrace ok - prav   #jak se správně napíše test, když chci do commentu dát nějaký text s uvozovkami? Např. když jsem použila text "vysněný" kurz, tak test neprojde.
...
#tvorba JSONu - body
    ...
    ${json_utf8} =      Encode String To Bytes     ${json}     UTF-8
      ...
      #OTAZKA: k čemu slouží vytoření hlavičky (header) zprávy?
