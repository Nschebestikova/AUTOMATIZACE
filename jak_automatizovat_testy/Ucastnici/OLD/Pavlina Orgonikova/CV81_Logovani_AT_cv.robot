...
# úrovně logování: TRACE, DEBUG, INFO (default), HTML, WARN, and ERROR
  Log                Ahoj
  Log                Url adresa je ${url}
  Log                Tohle je chyba     ERROR
  Log                Tohle je varování   WARN
  Log                Tohle je debug Log     DEBUG 
  Log                 Tohle je trace Log      TRACE
...
#  Debug
  ...
  # logování proměnné &{header}, tak aby se vypisovala do úrovně DEBUG. Je možné použít oba způsoby:
