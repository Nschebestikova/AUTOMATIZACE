...
Starting a browser with a page -
   New Browser    chromium    headless=false
   New Page       https://www.rohlik.cz/?hp=true&ftu=true
   Get Title      ==    Online supermarket Rohlik.cz — nejrychlejší doručení ve městě
   Type Text      id=searchGlobal     Ahoj
   Click   xpath=//*[@id="searchForm"]/button    sleep   5  #toto mi nefugovalo
   ${selector} =    Record Selector   tlačítko  #toto mi nefugovalo
   Click  ${selector}
