...
Uzivatel je prihlasen
                 Get Text                data-test=logout_button  ==         ${LOGOUT_TEXT}    #kontrola menu - nacist logout text pomoci lokatoru data-test
                 Get Url                                          ==         ${URL2}           #overeni spravne stranky ${URL2}
                 Take Screenshot

Uzivatel neni prihlasen
                 Get Text                data-test=login_link    ==          ${LOGIN_TEXT}      #kontrola menu-LOGIN_TEXT
                 Take Screenshot
